...
A formatação de campos em formulários HTML pode ser feita usando a biblioteca jMask.
Leia o artigo e veja um exemplo completo aqui [Como formatar campos de CPF, CEP, Telefone e moeda com jQuery (jMask)](https://www.blogson.com.br/como-formatar-campos-de-cpf-cep-telefone-e-moeda-com-jquery-jmask/)

## Exemplo de aplicação da biblioteca jMask
